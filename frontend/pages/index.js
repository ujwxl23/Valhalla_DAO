...
export default function Home() {
  ...
  const daoOwner = useContractRead({
    abi: ValhallaTableDAOABI,
    address: ValhallaTableDAOAddress,
    functionName: "owner",
  });
  ...
  return (
    <div className={inter.className}>
      <Head>
        <title>Valhalla DAO</title>
        <meta name="description" content="Valhalla DAO" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Valhalla!</h1>
          <div className={styles.description}>Welcome to the DAO!</div>
          <div className={styles.description}>
            Your Valhalla NFT Balance: {nftBalanceOfUser.data?.toString()}
            <br />
            {daoBalance.data && (
              <>
                Treasury Balance:{" "}
